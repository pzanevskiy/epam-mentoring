...
{
    public class ConfigurationManagerSettings : ConfigurationComponentBase
    {
        public const ConfigurationProviderType ProviderType = ConfigurationProviderType.ConfigurationManager;
